...
export default function StatsError({
  ...
  useEffect(() => {
    console.error(error);
    captureError(error, { scope: "stats", digest: error.digest });
  }, [error]);

  return (
    <div className="flex min-h-[60vh] items-center justify-center p-8">
      <div className="text-center max-w-md">
        <h2 className="text-xl font-bold mb-3">Couldn&apos;t load stats</h2>
        <p className="text-sm opacity-70 mb-6">
          Something went wrong while building the statistics view. Try again in
          a moment.
        </p>
